...
export const BlockCarrusel: React.FC<BlockProps> = ({alto, ancho }) => {
    let images = [
        'https://dr.savee-cdn.com/things/6/5/bf88254d8b7ecc785b8981.webp',
        'https://dr.savee-cdn.com/things/thumbnails/6/1/ffed31660b06bae4837215.webp',
        ...
        'https://dr.savee-cdn.com/things/6/5/8f752f38c5cf7c4c004575.webp',
        ...
        'https://dr.savee-cdn.com/things/6/4/ae30cb808b5748658e848c.webp',
        'https://dr.savee-cdn.com/things/thumbnails/5/f/b5d2b6a3d756228e99da41.webp',
        'https://dr.savee-cdn.com/things/thumbnails/5/9/79007d71e0043d6fa3897b.webp',
  ...
  return (
    <div className="main-container">
      <div className="slider-container">
        <div className="leftArrow" onClick={() => scrollToImage(SlideDirection.Prev)}>
          &#10092;
        </div>
        <div className="rightArrow" onClick={() => scrollToImage(SlideDirection.Next)}>
          &#10093;
        </div>
