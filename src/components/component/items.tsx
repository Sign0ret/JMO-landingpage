...
export const Items = () => {
  ...
  return (
    ...
    <ul className='text-gray-500 max-w-fit grid grid-cols-1 sm:grid-cols-2 text-right'>
        <li className='addDot cursor-pointer hover:text-black duration-300 max-w-fit'> <Link to="jmo_arqui" spy={true} smooth={true} offset={50} duration={500} >JMO ARQUITECTOS</Link> </li>
        ...
        <li className='addDot cursor-pointer hover:text-black duration-300 max-w-fit'> <a href="/testpage">TEST PAGE</a></li>
    </ul>
